curl -XPOST "http://storage.worksmobile.com/openapi/message/upload.api" \
         -H "consumerKey:BHOjH7zxMnPPqXwycpf8" \
         -H "authorization: Bearer " \
         -H "x-works-apiid:kr1unqNPDxwAo" \
         -H "x-works-resource-id:XAAAUFu0VclmHteAMq0SJrW1/4DBkYiobjWh9Hijhg1FJKP9rlOMqUr0APiEcWucIIcMuVN1z6fuo72wL+xCRNu/iLHG/3fGYJuO+d62TJwb61cq"\
         -o "./picture_download.png"